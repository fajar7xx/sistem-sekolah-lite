...
<html lang="en">
	<head>
		...
		<title>Homepage - Sistem Sekolah Lite</title>
		<link rel="stylesheet" href={{ asset("fe_theme/vendors/mdi/css/materialdesignicons.min.css") }}>
		<link rel="stylesheet" href={{ asset("fe_theme/vendors/owl.carousel/css/owl.carousel.css") }}>
		<link rel="stylesheet" href={{ asset("fe_theme/vendors/owl.carousel/css/owl.theme.default.min.css") }}>
		<link rel="stylesheet" href={{ asset("fe_theme/vendors/aos/css/aos.css") }}>
		<link rel="stylesheet" href={{ asset("fe_theme/vendors/jquery-flipster/css/jquery.flipster.css") }}>
		<link rel="stylesheet" href={{ asset("fe_theme/css/style.css") }}>
		<link rel="shortcut icon" href={{ asset("fe_theme/images/favicon.png") }} />
	</head>
	<body data-spy="scroll" data-target=".navbar" data-offset="50">
		...
		<nav class="navbar navbar-expand-lg fixed-top">
			<div class="container">
				<a class="navbar-brand" href="#">
                    {{-- <img src={{ asset("fe_theme/images/logo.svg") }} alt="Marshmallow"> --}}
                    Sekolah
                </a>
				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
					<div class="d-lg-none d-flex justify-content-between px-4 py-3 align-items-center">
						<img src={{ asset("fe_theme/images/logo-dark.svg") }} class="logo-mobile-menu" alt="logo">
							...
							<div class="main-banner">
								<div class="d-sm-flex justify-content-between">
									...
									<div class="mt-5 mt-lg-0">
										<img src={{ asset("fe_theme/images/group.png") }} alt="marsmello" class="img-fluid" data-aos="zoom-in-up">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row" data-aos="fade-up">
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src={{ asset("fe_theme/images/integrated-marketing.svg") }} alt="integrated-marketing" data-aos="zoom-in">
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box"   data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src={{ asset("fe_theme/images/design-development.svg") }} alt="design-development" data-aos="zoom-in">
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src={{ asset("fe_theme/images/digital-strategy.svg") }} alt="digital-strategy" data-aos="zoom-in">
					...
					<div class="row" data-aos="fade-up">
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box  pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src={{ asset("fe_theme/images/digital-marketing.svg") }} alt="digital-marketing" data-aos="zoom-in">
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Digital 
									Marketing
								</h6>
								<p>Lorem ipsum dolor sit amet, 
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src={{ asset("fe_theme/images/growth-strategy.svg") }} alt="growth-strategy" data-aos="zoom-in">
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box pb-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src={{ asset("fe_theme/images/saving-strategy.svg") }} alt="saving-strategy" data-aos="zoom-in">
					...
					<div class="row">
						<div class="col-sm-6" data-aos="fade-up">
							...
							<div class="d-flex justify-content-start mb-3">
								<img src={{ asset("fe_theme/images/tick.png") }} alt="tick" class="mr-3 tick-icon"  >
						...
						<div class="col-sm-6 text-right" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
							<img src={{ asset("fe_theme/images/idea.png") }} alt="idea" class="img-fluid">
						</div>
					</div>
				</div>
			</section>
			<section class="our-projects" id="projects">
				...
				<div class="mb-5" data-aos="fade-up">
					<div class="owl-carousel-projects owl-carousel owl-theme">
						<div class="item">
							<img src={{ asset("fe_theme/images/carousel/slider1.jpg") }} alt="slider">
						</div>
						<div class="item">
							<img src={{ asset("fe_theme/images/carousel/slider2.jpg") }} alt="slider">
						</div>
						<div class="item">
							<img src={{ asset("fe_theme/images/carousel/slider3.jpg") }} alt="slider">
						</div>
						<div class="item">
							<img src={{ asset("fe_theme/images/carousel/slider4.jpg") }} alt="slider">
						</div>
						<div class="item">
							<img src={{ asset("fe_theme/images/carousel/slider5.jpg") }} alt="slider">
						</div>
						<div class="item">
							<img src={{ asset("fe_theme/images/carousel/slider1.jpg") }} alt="slider">
						</div>
					...
					<div class="row pt-5 mt-5 pb-5 mb-5">
						<div class="col-sm-3">
							<div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-down">
								<img src={{ asset("fe_theme/images/satisfied-client.svg") }} alt="satisfied-client" class="mr-3">
								<div>
						...
						<div class="col-sm-3">
							<div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-up">
								<img src={{ asset("fe_theme/images/finished-project.svg") }} alt="satisfied-client" class="mr-3">
								<div>
						...
						<div class="col-sm-3">
							<div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-down">
								<img src={{ asset("fe_theme/images/team-members.svg") }} alt="Team Members" class="mr-3">
								<div>
						...
						<div class="col-sm-3">
							<div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-up">
								<img src={{ asset("fe_theme/images/our-blog-posts.svg") }} alt="Our Blog Posts" class="mr-3">
								<div>
								...
								<ul>
									<li>
										<div class="testimonial-item">
											<img src={{ asset("fe_theme/images/testimonial/testimonial1.jpg") }} alt="icon" class="testimonial-icons">
									...
									<li>
										<div class="testimonial-item">
											<img src={{ asset("fe_theme/images/testimonial/testimonial2.jpg") }} alt="icon" class="testimonial-icons">
											<p>Lorem ipsum dolor sit amet, consectetur
												pretium pretium tempor.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut pretium
											</p>
									...
									<li>
										<div class="testimonial-item">
											<img src={{ asset("fe_theme/images/testimonial/testimonial3.jpg") }} alt="icon" class="testimonial-icons">
											<p>Lorem ipsum dolor sit amet, consectetur
												pretium pretium tempor.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut pretium
											</p>
									...
									<li>
										<div class="testimonial-item">
											<img src={{ asset("fe_theme/images/testimonial/testimonial4.jpg") }} alt="icon" class="testimonial-icons">
											<p>Lorem ipsum dolor sit amet, consectetur
												pretium pretium tempor.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut pretium
											</p>
											<h6 class="testimonial-author">Mark Spenser</h6>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="d-sm-flex justify-content-between align-items-center">
								<img src={{ asset("fe_theme/images/deloit.svg") }} alt="deloit" class="p-2 p-lg-0" data-aos="fade-down"  data-aos-offset="-400">
								<img src={{ asset("fe_theme/images/erricson.svg") }} alt="erricson" class="p-2 p-lg-0" data-aos="fade-up"  data-aos-offset="-400">
								<img src={{ asset("fe_theme/images/netflix.svg") }} alt="netflix" class="p-2 p-lg-0" data-aos="fade-down"  data-aos-offset="-400">
								<img src={{ asset("fe_theme/images/instagram.svg") }} alt="instagram" class="p-2 p-lg-0" data-aos="fade-up"  data-aos-offset="-400">
								<img src={{ asset("fe_theme/images/coinbase.svg") }} alt="coinbase" class="p-2 p-lg-0" data-aos="fade-down"  data-aos-offset="-400">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row"  data-aos="fade-up" data-aos-offset="-300">
						<div class="col-sm-4">
							<div class="pricing-box">
								<img src={{ asset("fe_theme/images/starter.svg") }} alt="starter">
						...
						<div class="col-sm-4">
							<div class="pricing-box selected">
								<img src={{ asset("fe_theme/images/proffessional.svg") }} alt="starter">
						...
						<div class="col-sm-4">
							<div class="pricing-box">
								<img src={{ asset("fe_theme/images/premium.svg") }} alt="starter">
				...
				<div class="container">
					<div class="row mb-5 pb-5">
						<div class="col-sm-5" data-aos="fade-up" data-aos-offset="-500">
							<img src={{ asset("fe_theme/images/contact.jpg") }} alt="contact" class="img-fluid">
						</div>
			...
			<div class="footer-bottom">
				<div class="container">
					<div class="d-flex justify-content-between align-items-center">
						<div class="d-flex align-items-center">
                            {{-- <img src={{ asset("fe_theme/images/logo.svg") }} alt="logo" class="mr-3"> --}}
                            <h3>Sekolah</h3>
							<p class="mb-0 text-small pt-1">©2020 <a href="https://www.bootstrapdash.com" class="text-white" target="_blank">BootstrapDash</a>. All rights reserved.</p>
						</div>
						<div>
							<div class="d-flex">
		...
		<script src={{ asset("fe_theme/vendors/base/vendor.bundle.base.js") }}></script>
		<script src={{ asset("fe_theme/vendors/owl.carousel/js/owl.carousel.js") }}></script>
		<script src={{ asset("fe_theme/vendors/aos/js/aos.js") }}></script>
		<script src={{ asset("fe_theme/vendors/jquery-flipster/js/jquery.flipster.min.js") }}></script>
		<script src={{ asset("fe_theme/js/template.js") }}></script>
	</body>
</html>